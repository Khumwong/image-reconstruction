...
from img_ana.core import get_mlp_parameters_rigorous, create_hull, rotate_hull
from img_ana.processing import load_csv_fast, clean_data_batch, compute_mlp_rigorous, compute_average_image
from img_ana.visualization import (
    save_count_debug_overlay, save_wepl_debug_overlay, save_average_debug_overlay
)
from img_ana.utils import extract_angle_from_filename
import numpy as np
import torch
...
def main():
    ...
    OUTPUT_FOLDER = "./output_reconstruction/event"
