...
Refactored version of `hull_fast_optimized.py` (1446 lines) into maintainable modules.

## 📑 Documentation

- **[Quick Start Guide](docs/QUICK_START.md)** - Get started quickly
- **[Refactoring Summary](docs/REFACTORING_SUMMARY.md)** - Detailed refactoring documentation
- **[Structure Overview](docs/img_ana_structure.txt)** - Module structure diagram
...
python img_ana/examples/example_using_modules.py --csv_folder ./data --output ./output
...
| Feature | Original (`hull_fast_optimized.py`) | Refactored (`img_ana/`) |
|---------|-------------------------------------|-------------------------|
